...
Feature: Swap Shifts -  Settings
    ...
    Scenario Outline: Swap Shifts - Add Person Filter
        ...
        Examples:
            | tab         | personId | option |
            | Swap Shifts | 20017289 | Person |

    Scenario Outline: Swap Shifts Settings - Add Organisation Unit Filter
        And User clicks on the navigation menu
        And User clicks on Settings menu
        When User clicks on Settings "<tab>" tab
        And User clicks on Add filter button
        ...
        Examples:
            ...
            | Swap Shifts | FAA-ASEN         | Organisation Unit |