@employeeChoices
Feature: Employee Choices -  Settings
    ...
    Scenario Outline: Employee Choices Settings - Landing Page
        ...
        Examples:
            | tab                       |
            | Employee Choices Settings |

    Scenario Outline: Employee Choices - Add Person Filter
        And User clicks on the navigation menu
        And User clicks on Settings menu
        ...
        Examples:
            | tab                       | personId | option |
            | Employee Choices Settings | 20017289 | Person |

    Scenario Outline: Employee Choices Settings - Add Organisation Unit Filter
        And User clicks on the navigation menu
        And User clicks on Settings menu
        When User clicks on Settings "<tab>" tab
        And User clicks on Add filter button
        ...
        Examples:
            ...
            | Employee Choices Settings | FAA-ASEN         | Organisation Unit |